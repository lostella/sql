...
public class PPLQueryFormatter {
  ...
  private static class FormattingVisitor extends OpenSearchPPLParserBaseVisitor<String> {
    ...
    public String visitFromClause(OpenSearchPPLParser.FromClauseContext ctx) {
      ...
      if (ctx.tableOrSubqueryClause() != null) sb.append(safeVisit(ctx.tableOrSubqueryClause()));
      else if (ctx.tableFunction() != null) sb.append(safeVisit(ctx.tableFunction()));
      else if (ctx.dynamicSourceClause() != null) sb.append(safeVisit(ctx.dynamicSourceClause()));
      return sb.toString();
    }

    @Override
    public String visitTableOrSubqueryClause(OpenSearchPPLParser.TableOrSubqueryClauseContext ctx) {
      if (ctx == null) return EMPTY;
    ...
    public String visitDescribeCommand(OpenSearchPPLParser.DescribeCommandContext ctx) {
      return ctx == null ? EMPTY : KEYWORD_DESCRIBE + SPACE + safeVisit(ctx.tableSourceClause());
    }

    @Override
    public String visitFieldsCommand(OpenSearchPPLParser.FieldsCommandContext ctx) {
      return ctx == null ? EMPTY : KEYWORD_FIELDS + SPACE + safeVisit(ctx.fieldsCommandBody());
    }
    ...
    @Override
    public String visitSelectFieldExpression(OpenSearchPPLParser.SelectFieldExpressionContext ctx) {
      if (ctx == null) return EMPTY;
    ...
    public String visitStatsArgs(OpenSearchPPLParser.StatsArgsContext ctx) {
      ...
      if (ctx.partitionsArg() != null) ctx.partitionsArg().forEach(a -> args.add(safeVisit(a)));
      ...
      if (ctx.bucketNullableArg() != null)
        ctx.bucketNullableArg().forEach(a -> args.add(safeVisit(a)));
    ...
    public String visitWindowFunctionName(OpenSearchPPLParser.WindowFunctionNameContext ctx) {
      ...
      if (ctx.scalarWindowFunctionName() != null) return safeVisit(ctx.scalarWindowFunctionName());
    ...
    public String visitStatsByClause(OpenSearchPPLParser.StatsByClauseContext ctx) {
      ...
      if (ctx.bySpanClause() != null) {
        ...
        if (ctx.fieldList() != null) sb.append(COMMA_SEPARATOR).append(safeVisit(ctx.fieldList()));
      }
      return sb.toString();
    }
    ...
    public String visitEvalClause(OpenSearchPPLParser.EvalClauseContext ctx) {
      if (ctx == null) return EMPTY;
      return formatAssignment(safeVisit(ctx.fieldExpression()), safeVisit(ctx.logicalExpression()));
    }

    // ========== Sort, Head, Dedup Commands ==========

    @Override
    public String visitSortCommand(OpenSearchPPLParser.SortCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_SORT);
      if (ctx.count != null) {
        sb.append(SPACE).append(safeVisit(ctx.count));
      }
      if (ctx.sortbyClause() != null) {
        sb.append(SPACE).append(safeVisit(ctx.sortbyClause()));
      }
      return sb.toString();
    }

    @Override
    public String visitSortbyClause(OpenSearchPPLParser.SortbyClauseContext ctx) {
      if (ctx == null) return EMPTY;
      List<OpenSearchPPLParser.SortFieldContext> sortFields = ctx.sortField();
      StringBuilder sb = new StringBuilder();
      for (int i = 0; i < sortFields.size(); i++) {
        if (i > 0) sb.append(COMMA_SEPARATOR);
        sb.append(safeVisit(sortFields.get(i)));
      }
      return sb.toString();
    }

    @Override
    public String visitPrefixSortField(OpenSearchPPLParser.PrefixSortFieldContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder();
      if (ctx.MINUS() != null) {
        sb.append("- ");
      ...
      sb.append(safeVisit(ctx.sortFieldExpression()));
      return sb.toString();
    }

    @Override
    public String visitSuffixSortField(OpenSearchPPLParser.SuffixSortFieldContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(safeVisit(ctx.sortFieldExpression()));
      // Note: We don't output ASC/DESC suffix as it's optional in formatted output
      return sb.toString();
    }

    @Override
    public String visitDefaultSortField(OpenSearchPPLParser.DefaultSortFieldContext ctx) {
      if (ctx == null) return EMPTY;
      return safeVisit(ctx.sortFieldExpression());
    }

    @Override
    public String visitSortFieldExpression(OpenSearchPPLParser.SortFieldExpressionContext ctx) {
      if (ctx == null) return EMPTY;
      if (ctx.fieldExpression() != null) {
        return safeVisit(ctx.fieldExpression());
      }
      return visitChildren(ctx);
    }

    @Override
    public String visitHeadCommand(OpenSearchPPLParser.HeadCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_HEAD);
      if (ctx.number != null) {
        sb.append(SPACE).append(safeVisit(ctx.number));
      }
      if (ctx.from != null) {
        sb.append(SPACE).append(KEYWORD_FROM).append(SPACE).append(safeVisit(ctx.from));
      }
      return sb.toString();
    }

    @Override
    public String visitDedupCommand(OpenSearchPPLParser.DedupCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_DEDUP);
      if (ctx.number != null) {
        sb.append(SPACE).append(safeVisit(ctx.number));
      }
      ...
      if (ctx.keepempty != null) {
        sb.append(SPACE)
            .append(KEYWORD_KEEPEMPTY)
            .append(OP_EQUAL)
            .append(safeVisit(ctx.keepempty));
      }
      if (ctx.consecutive != null) {
        sb.append(SPACE)
            .append(KEYWORD_CONSECUTIVE)
            .append(OP_EQUAL)
            .append(safeVisit(ctx.consecutive));
      }
      return sb.toString();
    }
    ...
    @Override
    public String visitRenameCommand(OpenSearchPPLParser.RenameCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_RENAME);
      List<OpenSearchPPLParser.RenameClasueContext> clauses = ctx.renameClasue();
      for (int i = 0; i < clauses.size(); i++) {
        sb.append(i == 0 ? SPACE : COMMA_SEPARATOR).append(safeVisit(clauses.get(i)));
      }
      return sb.toString();
    ...
    @Override
    public String visitRenameClasue(OpenSearchPPLParser.RenameClasueContext ctx) {
      if (ctx == null) return EMPTY;
      return (safeVisit(ctx.orignalField)
          + SPACE
          + KEYWORD_AS
          + SPACE
          + safeVisit(ctx.renamedField));
    }

    // ========== Rare and Top Commands ==========

    @Override
    public String visitRareTopCommand(OpenSearchPPLParser.RareTopCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder();
      if (ctx.TOP() != null) {
        sb.append(KEYWORD_TOP);
      } else if (ctx.RARE() != null) {
        sb.append(KEYWORD_RARE);
      }
      if (ctx.number != null) {
        sb.append(SPACE).append(safeVisit(ctx.number));
      }
      ...
      if (ctx.byClause() != null) {
        sb.append(SPACE).append(safeVisit(ctx.byClause()));
      }
      return sb.toString();
    }

    @Override
    public String visitByClause(OpenSearchPPLParser.ByClauseContext ctx) {
      if (ctx == null) return EMPTY;
      return KEYWORD_BY + SPACE + safeVisit(ctx.fieldList());
    }

    // ========== Grok, Parse, Patterns Commands ==========

    @Override
    public String visitGrokCommand(OpenSearchPPLParser.GrokCommandContext ctx) {
      if (ctx == null) return EMPTY;
      return (KEYWORD_GROK + SPACE + safeVisit(ctx.source_field) + SPACE + safeVisit(ctx.pattern));
    }

    @Override
    public String visitParseCommand(OpenSearchPPLParser.ParseCommandContext ctx) {
      if (ctx == null) return EMPTY;
      return (KEYWORD_PARSE + SPACE + safeVisit(ctx.source_field) + SPACE + safeVisit(ctx.pattern));
    }

    @Override
    public String visitPatternsCommand(OpenSearchPPLParser.PatternsCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_PATTERNS);
      if (ctx.source_field != null) {
        sb.append(SPACE).append(safeVisit(ctx.source_field));
      }
      if (ctx.statsByClause() != null) {
        sb.append(SPACE).append(safeVisit(ctx.statsByClause()));
      }
      for (OpenSearchPPLParser.PatternsParameterContext param : ctx.patternsParameter()) {
        sb.append(SPACE).append(safeVisit(param));
      }
      return sb.toString();
    }

    @Override
    public String visitPatternsParameter(OpenSearchPPLParser.PatternsParameterContext ctx) {
      if (ctx == null) return EMPTY;
      if (ctx.pattern != null) {
        return "pattern=" + safeVisit(ctx.pattern);
      }
      if (ctx.new_field != null) {
        return "new_field=" + safeVisit(ctx.new_field);
      }
      return getOriginalText(ctx);
    }
    ...
    @Override
    public String visitFillNullValueWithFields(
        OpenSearchPPLParser.FillNullValueWithFieldsContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_FILLNULL);
      sb.append(SPACE).append(KEYWORD_VALUE).append(OP_EQUAL).append(safeVisit(ctx.replacement));
      if (ctx.fieldList() != null) {
        sb.append(SPACE).append(safeVisit(ctx.fieldList()));
      }
      return sb.toString();
    ...
    @Override
    public String visitFillNullValueAllFields(
        OpenSearchPPLParser.FillNullValueAllFieldsContext ctx) {
      if (ctx == null) return EMPTY;
      return KEYWORD_FILLNULL + SPACE + KEYWORD_VALUE + OP_EQUAL + safeVisit(ctx.replacement);
    }

    @Override
    public String visitFillNullWithClause(OpenSearchPPLParser.FillNullWithClauseContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_FILLNULL);
      if (ctx.fillNullWith() != null) {
        sb.append(SPACE).append(safeVisit(ctx.fillNullWith()));
      }
      return sb.toString();
    }

    @Override
    public String visitFillNullUsingClause(OpenSearchPPLParser.FillNullUsingClauseContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_FILLNULL);
      if (ctx.fillNullUsing() != null) {
        sb.append(SPACE).append(safeVisit(ctx.fillNullUsing()));
      }
      return sb.toString();
    }

    @Override
    public String visitFillNullWith(OpenSearchPPLParser.FillNullWithContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_WITH);
      sb.append(SPACE).append(safeVisit(ctx.replacement));
      if (ctx.fieldList() != null) {
        sb.append(SPACE).append(KEYWORD_IN).append(SPACE).append(safeVisit(ctx.fieldList()));
      }
      return sb.toString();
    }

    @Override
    public String visitFillNullUsing(OpenSearchPPLParser.FillNullUsingContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_USING);
      List<OpenSearchPPLParser.ReplacementPairContext> pairs = ctx.replacementPair();
      for (int i = 0; i < pairs.size(); i++) {
        sb.append(i == 0 ? SPACE : COMMA_SEPARATOR).append(safeVisit(pairs.get(i)));
      }
      return sb.toString();
    }

    @Override
    public String visitReplacementPair(OpenSearchPPLParser.ReplacementPairContext ctx) {
      if (ctx == null) return EMPTY;
      return safeVisit(ctx.fieldExpression()) + OP_EQUAL + safeVisit(ctx.replacement);
    }

    // ========== Trendline Command ==========

    @Override
    public String visitTrendlineCommand(OpenSearchPPLParser.TrendlineCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_TRENDLINE);
      if (ctx.sortField() != null) {
        sb.append(SPACE).append(KEYWORD_SORT).append(SPACE).append(safeVisit(ctx.sortField()));
      }
      List<OpenSearchPPLParser.TrendlineClauseContext> clauses = ctx.trendlineClause();
      for (int i = 0; i < clauses.size(); i++) {
        sb.append(i == 0 ? SPACE : COMMA_SEPARATOR).append(safeVisit(clauses.get(i)));
      }
      return sb.toString();
    ...
    @Override
    public String visitTrendlineClause(OpenSearchPPLParser.TrendlineClauseContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder();
      sb.append(safeVisit(ctx.trendlineType()))
          .append(LPAREN)
          .append(safeVisit(ctx.numberOfDataPoints))
          .append(COMMA_SEPARATOR)
          .append(safeVisit(ctx.field))
          .append(RPAREN);
      if (ctx.alias != null) {
        sb.append(SPACE).append(KEYWORD_AS).append(SPACE).append(safeVisit(ctx.alias));
      }
    ...
    @Override
    public String visitTrendlineType(OpenSearchPPLParser.TrendlineTypeContext ctx) {
      if (ctx == null) return EMPTY;
      return normalizeKeyword(ctx.getText());
    }

    // ========== Expand and Flatten Commands ==========

    @Override
    public String visitExpandCommand(OpenSearchPPLParser.ExpandCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_EXPAND);
      sb.append(SPACE).append(safeVisit(ctx.fieldExpression()));
      if (ctx.alias != null) {
        sb.append(SPACE).append(KEYWORD_AS).append(SPACE).append(safeVisit(ctx.alias));
      }
      return sb.toString();
    ...
    @Override
    public String visitFlattenCommand(OpenSearchPPLParser.FlattenCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_FLATTEN);
      sb.append(SPACE).append(safeVisit(ctx.fieldExpression()));
      if (ctx.aliases != null) {
        sb.append(SPACE).append(KEYWORD_AS).append(SPACE).append(safeVisit(ctx.aliases));
      }
      return sb.toString();
    }
    ...
    @Override
    public String visitLookupCommand(OpenSearchPPLParser.LookupCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_LOOKUP);
      sb.append(SPACE).append(safeVisit(ctx.tableSource()));
      if (ctx.lookupMappingList() != null) {
        sb.append(SPACE).append(safeVisit(ctx.lookupMappingList()));
      }
      if (ctx.APPEND() != null) {
        sb.append(SPACE).append(KEYWORD_APPEND);
      } else if (ctx.REPLACE() != null) {
        sb.append(SPACE).append(KEYWORD_REPLACE);
      } else if (ctx.OUTPUT() != null) {
        sb.append(SPACE).append(KEYWORD_OUTPUT);
      }
      if (ctx.outputCandidateList() != null) {
        sb.append(SPACE).append(safeVisit(ctx.outputCandidateList()));
      }
      return sb.toString();
    }

    @Override
    public String visitLookupMappingList(OpenSearchPPLParser.LookupMappingListContext ctx) {
      if (ctx == null) return EMPTY;
      List<OpenSearchPPLParser.LookupPairContext> pairs = ctx.lookupPair();
      StringBuilder sb = new StringBuilder();
      for (int i = 0; i < pairs.size(); i++) {
        if (i > 0) sb.append(COMMA_SEPARATOR);
        sb.append(safeVisit(pairs.get(i)));
      }
      return sb.toString();
    }

    @Override
    public String visitOutputCandidateList(OpenSearchPPLParser.OutputCandidateListContext ctx) {
      if (ctx == null) return EMPTY;
      List<OpenSearchPPLParser.LookupPairContext> pairs = ctx.lookupPair();
      StringBuilder sb = new StringBuilder();
      for (int i = 0; i < pairs.size(); i++) {
    ...
    @Override
    public String visitLookupPair(OpenSearchPPLParser.LookupPairContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(safeVisit(ctx.inputField));
      if (ctx.outputField != null) {
        sb.append(SPACE).append(KEYWORD_AS).append(SPACE).append(safeVisit(ctx.outputField));
      }
      return sb.toString();
    }
    ...
    @Override
    public String visitBinCommand(OpenSearchPPLParser.BinCommandContext ctx) {
      if (ctx == null) return EMPTY;
      StringBuilder sb = new StringBuilder(KEYWORD_BIN);
      sb.append(SPACE).append(safeVisit(ctx.fieldExpression()));
      for (OpenSearchPPLParser.BinOptionContext opt : ctx.binOption()) {
        sb.append(SPACE).append(safeVisit(opt));
      }
      if (ctx.alias != null) {
        sb.append(SPACE).append(KEYWORD_AS).append(SPACE).append(safeVisit(ctx.alias));
      }
    ...
    @Override
    public String visitBinOption(OpenSearchPPLParser.BinOptionContext ctx) {
      if (ctx == null) return EMPTY;
      if (ctx.span != null) {
        return KEYWORD_SPAN + OP_EQUAL + safeVisit(ctx.span);
      }
      if (ctx.bins != null) {
        return KEYWORD_BINS + OP_EQUAL + safeVisit(ctx.bins);
      }
      if (ctx.minspan != null) {
        return "minspan=" + safeVisit(ctx.minspan);
      }
      if (ctx.start != null) {
        return "start=" + safeVisit(ctx.start);
      }
      if (ctx.end != null) {
        return "end=" + safeVisit(ctx.end);
      }
      return getOriginalText(ctx);
    }

    @Override
    public String visitNumericSpanValue(OpenSearchPPLParser.NumericSpanValueContext ctx) {
      if (ctx == null) return EMPTY;
      return safeVisit(ctx.spanLiteral());
    }

    @Override
    public String visitSpanLiteral(OpenSearchPPLParser.SpanLiteralContext ctx) {
      if (ctx == null) return EMPTY;
      return ctx.getText();
    }
    ...
    public String visitCompareExpr(OpenSearchPPLParser.CompareExprContext ctx) {
      ...
      return formatBinaryExpr(
          safeVisit(ctx.left), formatComparisonOp(ctx.comparisonOperator()), safeVisit(ctx.right));
    }
    ...
    public String visitBinaryArithmetic(OpenSearchPPLParser.BinaryArithmeticContext ctx) {
      ...
      return formatBinaryExpr(
          safeVisit(ctx.valueExpression(0)), op, safeVisit(ctx.valueExpression(1)));
    }
    ...
    public String visitFieldExpr(OpenSearchPPLParser.FieldExprContext ctx) {
      return ctx == null ? EMPTY : formatArithmeticInFieldName(safeVisit(ctx.fieldExpression()));
    }
    ...
    public String visitDistinctCountFunctionCall(
      ...
      String funcName =
          ctx.DISTINCT_COUNT() != null
              ? FUNC_DISTINCT_COUNT
              : ctx.DC() != null ? FUNC_DC : FUNC_DISTINCT_COUNT_APPROX;
    ...
    @Override
    public String visitIdentsAsQualifiedName(OpenSearchPPLParser.IdentsAsQualifiedNameContext ctx) {
      if (ctx == null) return EMPTY;
    ...
    public String visitLiteralValue(OpenSearchPPLParser.LiteralValueContext ctx) {
      if (ctx == null) return EMPTY;
      // Delegate to child visitors (e.g., booleanLiteral, stringLiteral, etc.)
      // to ensure proper formatting/normalization
    ...
    public String visitSearchFieldCompare(OpenSearchPPLParser.SearchFieldCompareContext ctx) {
      ...
      String op =
          ctx.searchComparisonOperator() != null
              ...
              : OP_EQUAL;
      return formatBinaryExpr(safeVisit(ctx.fieldExpression()), op, safeVisit(ctx.searchLiteral()));
    }
